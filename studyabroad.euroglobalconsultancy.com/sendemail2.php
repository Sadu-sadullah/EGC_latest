...
if(isset($_POST["first_email"]))
{
 ...
 if($first_name_error == '' && $last_name_error == '' && $email_error == '' || $address_error == '' || $phone_error == '')
 {
            ...
            $phone=$_POST['country'];
            $course1=$_POST['study_abroad'];
            $course2=$_POST['it_consultancy'];
            $course3=$_POST['training'];
            $address=$_POST['address'];
        ...
        $mail->Subject = 'Euro Global Consultancy Client is Here....';
        ...
        $email_message .= "Name: ".clean_string($name)."<br/>";
         $email_message .= "Contact: ".clean_string($comment)." - ".clean_string($phone)."<br/>";
           $email_message .= "Course: ".$course1.", ".$course2.", ".$course3."<br/>";
        $email_message .= "Queries: ".clean_string($address)."<br/>";
